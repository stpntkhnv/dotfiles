...
Дальше — то, что более ранние тексты этого репозитория сводили к одной фразе
«все три случая падают закрыто», и что при более внимательном чтении кода и
...
одной ветки. Контейнер с Ziti (фича `ziti`, см. [network.md](network.md))
kill-switch не поддерживает никак, а не «поддерживает частично».
...
Разобрано в «Границах» выше. Вывод для документации: более ранняя формулировка
этого репозитория («все три случая падают закрыто... table inet покрывает и
