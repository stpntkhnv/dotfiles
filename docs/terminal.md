...
программа в системе со своим контекстом рендеринга — не вкладка старой и не
окно внутри уже запущенного процесса. Расчёт именно на это: несколько тяжёлых
окон (например, с работающими агентами) не должны мешать друг другу через
общий процесс, хотя насколько сильно это помогает на практике — здесь не
измерялось (подробности и оговорка — ниже, в «Как это работает»).
