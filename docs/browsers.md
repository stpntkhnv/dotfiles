...
памяти; такую роль в репозитории играет `earlyoom` — фича каталога со
2 августа 2026 (подробности — [hardware.md](hardware.md), раздел про
earlyoom). Авария 30 июля 2026
