...
Personal access tokens организаций лежат в папке `PAT` личного хранилища
Bitwarden, по записи на организацию. Достать на хосте:

```sh
pat                # список имён
pat digi3          # сам токен
pat -c digi3       # в буфер обмена, без вывода на экран
```

Как это устроено и что делать, когда команда ругается, —
